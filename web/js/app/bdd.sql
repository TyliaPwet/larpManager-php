...
CREATE TABLE geo_picto (id INT UNSIGNED AUTO_INCREMENT NOT NULL, categ VARCHAR(50) CHARACTER SET utf8 COLLATE `utf8_unicode_ci` NOT NULL, geojson LONGTEXT, discr VARCHAR(255) CHARACTER SET utf8 COLLATE `utf8_unicode_ci` NOT NULL DEFAULT 'extended', PRIMARY KEY(id)) ENGINE =InnoDB;

/* Exemples de villes en Vanaheim */
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('ville', '{"type":"Point","coordinates":[48.390625,-15.8125]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('ville', '{"type":"Point","coordinates":[49.765625,-2.8125]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('ville', '{"type":"Point","coordinates":[59.953125,-10.3125]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('ville', '{"type":"Point","coordinates":[35.015625,-9]}');

/* Exemples de pictos 'E' */
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[65.1875,-0.984375]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[146.9375,-10.234375]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[176.0625,-25.984375]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[236.5625,-63.484375]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[174.859375,-107.859375]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[159.53125,-135.796875]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[132.78125,-134.296875]}');
/* non passées en base dev : */
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[226.15625,-161.046875]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[63.90625,-155.546875]}');
INSERT INTO geo_picto (categ, geojson, src, rotation) VALUES ('exploration', '{"type":"Point","coordinates":[50.40625,-128.046875]}');
