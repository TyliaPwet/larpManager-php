...
use LarpManager\Entities\BaseGeoLayer;

/**
 * LarpManager\Entities\GeoMapLayer
 *
 * @Entity()
 */
class GeoLayer extends BaseGeoLayer
{
	...
	public function	jsonSerialize() {
		return array (
			...
			'propsModify' => $this->getCateg()->getGeomtype()->getPropertiesmodify()
		);
	}
}
